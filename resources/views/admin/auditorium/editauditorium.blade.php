                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.updateAuditorium') }}" method="post" enctype="multipart/form-data">
                            ...
                            <input type="submit" class="btn btn-success btn-rounded waves-effect waves-light"
                                name="submit" value="update Auditorium  " id="submitBtn">
                        </form>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="/admin/auditotium-hall" class="btn btn-success sm" title="Add Audutorium Slots"
                                    id="delete"> <i class="fas fa-plus-square"></i></a>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($auditoriumHalls as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ '/admin/delete-halls/' . encryptId($item['id']) }}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="/chairman/create-auditorium-services" class="btn btn-success sm"
                                    title="Add Audutorium Slots" id="delete"> <i class="fas fa-plus-square"></i></a>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($auditoriumServices as $auditoriumService)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ ' /chairman/delete-services/' . encryptId($auditoriumService['id']) }}"
                                                    class="btn btn-danger sm" title="Delete Data" id="delete"> <i
                                                        class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="/chairman/auditorium-slots" class="btn btn-success sm" title="Add Slots"
                                    id="delete"> <i class="fas fa-plus-square"></i></a>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($auditoriumSlots as $auditoriumSlot)
                                        <tr>
                                            ...
                                            <td>{{ getHallsName($auditoriumSlot->hall_id) }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ ' /chairman/delete-slots/' . encryptId($auditoriumSlot['id']) }}"
                                                    class="btn btn-danger sm" title="Delete Data" id="delete"> <i
                                                        class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
